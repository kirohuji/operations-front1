<template>
  <div>
    <ManagerTable
      ...
      @search="handleSearch"
      @create="$router.push(`/information/prpgd_edu/create/${0}`)"
    >
      ...
      <template v-slot:operation="{ row }">
        <div style="display: flex;justify-content: space-between;">
          <router-link :to="`/information/prpgd_edu/edit/${row.i_id}`">
          ...
          <el-link
            type="primary"
            @click="$router.push(`/information/prpgd_edu/check/${row.i_id}`)"
          >查看</el-link>
