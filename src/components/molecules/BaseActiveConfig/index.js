              ...
              {this.type === 'healthCheck' && (
                <div style='margin: 8px 80px'>
                  <el-checkbox-group vModel={this.typeList.healthCheck.activity_type}>
                    <el-checkbox label='3'>慢跑健身-1</el-checkbox>
                    <el-checkbox label='7'>慢跑健身-2</el-checkbox>
                    <el-checkbox label='8'>慢跑健身-3</el-checkbox>
                    <el-checkbox label='9'>慢步走-1</el-checkbox>
                    <el-checkbox label='10'>慢步走-2</el-checkbox>
                    <el-checkbox label='11'>慢步走-3</el-checkbox>
                    <el-checkbox label='4'>太极拳</el-checkbox>
                    <el-checkbox label='5'>篮球</el-checkbox>
                    <el-checkbox label='6'>健身舞蹈</el-checkbox>
                  </el-checkbox-group>
                </div>
              )}
            </el-radio-group>
